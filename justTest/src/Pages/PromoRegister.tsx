...
const PremoRegister = () => {
  ...
  const schema = yup.object({
    ...
    confirm: yup.string().oneOf([yup.ref("password must Match")]),
  });
  const {
    reset,
    register,
    ...
    <div className="flex items-center justify-center w-full h-screen bg-[white]">
      ...
      >
        <div className="pl-4 mt-8 ">
          <span className="font-bold text-[20px] mb-[30px] ">
            Registering a Promo Account
          </span>
        ...
        <div className="ml-[70px] mt-[20px] mr-[55px]">
          <Link to="/signIn">
            <button
              className="border py-4 rounded-md w-[90%] bg-purple-600 text-[white] font-bold mb-5"
              type="submit"
              onClick={() => {
                setToggle(true);
              }}
